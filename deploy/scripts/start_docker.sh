...
docker pull 869935088600.dkr.ecr.us-east-1.amazonaws.com/skyx-ecr:v5
...
docker run -d -p 80:5000 -e DAGSHUB_PAT=eac8585ad4083e279c466bd0514fffdf07054e30 --name skyx-app 869935088600.dkr.ecr.us-east-1.amazonaws.com/skyx-ecr:v5